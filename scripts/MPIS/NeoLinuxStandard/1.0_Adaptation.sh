...
curl -fsSL https://github.com/K2254IVV/MASTERNUX/raw/refs/heads/main/scripts/MPIS/NeoLinuxStandard/pkglist.txt | sudo pacman -S --noconfirm -
...
curl -fsSL https://github.com/K2254IVV/MASTERNUX/raw/refs/heads/main/scripts/MPIS/NeoLinuxStandard/AURpkglist.txt | yay -S --noconfirm --answerdiff None --answeredit None -

echo "[5/5] 📦 Установка Пакетов из Flathub..."
curl -fsSL https://github.com/K2254IVV/MASTERNUX/raw/refs/heads/main/scripts/MPIS/NeoLinuxStandard/FHpkglist.txt | xargs flatpak install -y --noninteractive
...
curl -fsSL "https://github.com/K2254IVV/MASTERNUX/raw/refs/heads/main/scripts/MPIS/NeoLinuxStandard/config.txt" -o ~/.config/kitty/kitty.conf
